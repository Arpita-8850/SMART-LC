...
<br></br>
		...
		<p style="margin-left:50px; margin-top: 10px; font-size:16px; position:absolute;">Sr no.:<?php echo $row["bonafideno"]; ?> </p>
		<br></br>
		<p style="font-size:16px;">  मैं इसके द्वारा यह प्रमाणित करता हूँ  की<u><?php echo $row["name"]; ?> </u> नियमित रूप से शिक्षा प्राप्त करने के उद्देश्य से इस कॉलेज में भाग लेता है, जिस संस्थान की मैं इस दिन प्रिंसिपल और उसकी उम्र है, मेरे विश्वास के अनुसार और मेरे द्वारा किए गए ज्ञान से, <u><?php echo $row["age"]; ?></u>साल, उसकी / उसके जन्म की तारीख के रूप में कॉलेज रजिस्टर में दर्ज किया जा रहा है  <u><?php echo $row["bd"]; ?></u></p>
		<p style="font-size:16px;"> इसलिए, वह सीजन टिकट का हकदार है, जो वयस्कों के लिए शुल्क की आधी दरों से नीचे विस्तृत है :-</p>
		<p style="font-size:16px;"> I hereby certify that <u><?php echo $row["name"]; ?> </u> regularly attends this college for the purpose of recieveing education, the institution of which I am the Principal and his/her age this day, according to my belief and from enqueries I have made is, <u><?php echo $row["age"]; ?></u> years, his/her date of birth as entered in the College Register being  <u><?php echo $row["bd"]; ?></u></p>
		<p style="font-size:16px;"> He / She is therefore, entitled to the season ticket as detailed below at half the full rates charged for adults :-</p>
    ...
    <td> <u><?php echo $row["month"]; ?></td>
    <td> <u><?php echo $row["place"]; ?></td>
    <td>Bandra</td>
  </tr>
</table>
	...
	<div id="principal1"> 
		...
		<form action="insert1.php"  method="post"><input id="printpagebutton" type="submit" name="print" value="PRINT" class="print" onclick="printpage()"/>  
        </form>
		</div>
